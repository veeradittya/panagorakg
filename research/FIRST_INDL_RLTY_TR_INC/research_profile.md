# FIRST INDL RLTY TR INC — Research Profile
# CUSIP: 32054K103
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: FIRST INDL RLTY TR INC
CUSIP: 32054K103
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=FIRST%20INDL%20RLTY%20TR%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 32054K103
...
- The abbreviated SEC issuer name "FIRST INDL RLTY TR INC" needs manual matching
