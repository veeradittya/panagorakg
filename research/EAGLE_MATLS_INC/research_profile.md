# EAGLE MATLS INC — Research Profile
# CUSIP: 26969P108
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: EAGLE MATLS INC
CUSIP: 26969P108
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=EAGLE%20MATLS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 26969P108
...
- The abbreviated SEC issuer name "EAGLE MATLS INC" needs manual matching
