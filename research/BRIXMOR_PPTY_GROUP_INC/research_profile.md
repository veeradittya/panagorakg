# BRIXMOR PPTY GROUP INC — Research Profile
# CUSIP: 11120U105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: BRIXMOR PPTY GROUP INC
CUSIP: 11120U105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=BRIXMOR%20PPTY%20GROUP%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 11120U105
...
- The abbreviated SEC issuer name "BRIXMOR PPTY GROUP INC" needs manual matching
