# ADTALEM GLOBAL ED INC — Research Profile
# CUSIP: 00737L103
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: ADTALEM GLOBAL ED INC
CUSIP: 00737L103
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=ADTALEM%20GLOBAL%20ED%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 00737L103
...
- The abbreviated SEC issuer name "ADTALEM GLOBAL ED INC" needs manual matching
