# UNIVERSAL HLTH SVCS INC — Research Profile
# CUSIP: 913903100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: UNIVERSAL HLTH SVCS INC
CUSIP: 913903100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=UNIVERSAL%20HLTH%20SVCS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 913903100
...
- The abbreviated SEC issuer name "UNIVERSAL HLTH SVCS INC" needs manual matching
