# CARLISLE COS INC — Research Profile
# CUSIP: 142339100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: CARLISLE COS INC
CUSIP: 142339100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=CARLISLE%20COS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 142339100
...
- The abbreviated SEC issuer name "CARLISLE COS INC" needs manual matching
