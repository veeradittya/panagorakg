# LIMBACH HLDGS INC — Research Profile
# CUSIP: 53263P105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: LIMBACH HLDGS INC
CUSIP: 53263P105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=LIMBACH%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 53263P105
...
- The abbreviated SEC issuer name "LIMBACH HLDGS INC" needs manual matching
