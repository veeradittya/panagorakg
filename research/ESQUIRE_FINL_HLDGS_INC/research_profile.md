# ESQUIRE FINL HLDGS INC — Research Profile
# CUSIP: 29667J101
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: ESQUIRE FINL HLDGS INC
CUSIP: 29667J101
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=ESQUIRE%20FINL%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 29667J101
...
- The abbreviated SEC issuer name "ESQUIRE FINL HLDGS INC" needs manual matching
