# WINNEBAGO INDS INC — Research Profile
# CUSIP: 974637100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: WINNEBAGO INDS INC
CUSIP: 974637100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=WINNEBAGO%20INDS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 974637100
...
- The abbreviated SEC issuer name "WINNEBAGO INDS INC" needs manual matching
