# SOUTHERN MO BANCORP INC — Research Profile
# CUSIP: 843380106
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: SOUTHERN MO BANCORP INC
CUSIP: 843380106
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=SOUTHERN%20MO%20BANCORP%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 843380106
...
- The abbreviated SEC issuer name "SOUTHERN MO BANCORP INC" needs manual matching
