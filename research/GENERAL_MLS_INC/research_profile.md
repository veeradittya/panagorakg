# GENERAL MLS INC — Research Profile
# CUSIP: 370334104
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: GENERAL MLS INC
CUSIP: 370334104
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=GENERAL%20MLS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 370334104
...
- The abbreviated SEC issuer name "GENERAL MLS INC" needs manual matching
