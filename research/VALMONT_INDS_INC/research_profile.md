# VALMONT INDS INC — Research Profile
# CUSIP: 920253101
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: VALMONT INDS INC
CUSIP: 920253101
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=VALMONT%20INDS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 920253101
...
- The abbreviated SEC issuer name "VALMONT INDS INC" needs manual matching
