# RPM INTL INC — Research Profile
# CUSIP: 749685103
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: RPM INTL INC
CUSIP: 749685103
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=RPM%20INTL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 749685103
...
- The abbreviated SEC issuer name "RPM INTL INC" needs manual matching
