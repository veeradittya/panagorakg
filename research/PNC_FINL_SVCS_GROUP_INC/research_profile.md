# PNC FINL SVCS GROUP INC — Research Profile
# CUSIP: 693475105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: PNC FINL SVCS GROUP INC
CUSIP: 693475105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=PNC%20FINL%20SVCS%20GROUP%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 693475105
...
- The abbreviated SEC issuer name "PNC FINL SVCS GROUP INC" needs manual matching
