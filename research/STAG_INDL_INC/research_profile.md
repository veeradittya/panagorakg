# STAG INDL INC — Research Profile
# CUSIP: 85254J102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: STAG INDL INC
CUSIP: 85254J102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=STAG%20INDL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 85254J102
...
- The abbreviated SEC issuer name "STAG INDL INC" needs manual matching
