# INTERCORP FINL SVCS INC — Research Profile
# CUSIP: P5626F128
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: INTERCORP FINL SVCS INC
CUSIP: P5626F128
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=INTERCORP%20FINL%20SVCS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: P5626F128
...
- The abbreviated SEC issuer name "INTERCORP FINL SVCS INC" needs manual matching
