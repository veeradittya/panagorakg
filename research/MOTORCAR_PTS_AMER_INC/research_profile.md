# MOTORCAR PTS AMER INC — Research Profile
# CUSIP: 620071100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: MOTORCAR PTS AMER INC
CUSIP: 620071100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=MOTORCAR%20PTS%20AMER%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 620071100
...
- The abbreviated SEC issuer name "MOTORCAR PTS AMER INC" needs manual matching
