# SUN CMNTYS INC — Research Profile
# CUSIP: 866674104
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: SUN CMNTYS INC
CUSIP: 866674104
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=SUN%20CMNTYS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 866674104
...
- The abbreviated SEC issuer name "SUN CMNTYS INC" needs manual matching
