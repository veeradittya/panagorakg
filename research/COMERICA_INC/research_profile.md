# COMERICA INC — Research Profile
# CUSIP: 200340107
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: COMERICA INC
CUSIP: 200340107
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=COMERICA%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 200340107
...
- The abbreviated SEC issuer name "COMERICA INC" needs manual matching
