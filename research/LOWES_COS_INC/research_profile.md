# LOWES COS INC — Research Profile
# CUSIP: 548661107
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: LOWES COS INC
CUSIP: 548661107
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=LOWES%20COS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 548661107
...
- The abbreviated SEC issuer name "LOWES COS INC" needs manual matching
