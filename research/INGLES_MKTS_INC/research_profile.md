# INGLES MKTS INC — Research Profile
# CUSIP: 457030104
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: INGLES MKTS INC
CUSIP: 457030104
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=INGLES%20MKTS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 457030104
...
- The abbreviated SEC issuer name "INGLES MKTS INC" needs manual matching
