# BJS WHSL CLUB HLDGS INC — Research Profile
# CUSIP: 05550J101
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: BJS WHSL CLUB HLDGS INC
CUSIP: 05550J101
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=BJS%20WHSL%20CLUB%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 05550J101
...
- The abbreviated SEC issuer name "BJS WHSL CLUB HLDGS INC" needs manual matching
