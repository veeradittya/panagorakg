# PURE STORAGE INC — Research Profile
# CUSIP: 74624M102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: PURE STORAGE INC
CUSIP: 74624M102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=PURE%20STORAGE%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 74624M102
...
- The abbreviated SEC issuer name "PURE STORAGE INC" needs manual matching
