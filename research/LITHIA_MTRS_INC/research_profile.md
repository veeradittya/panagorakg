# LITHIA MTRS INC — Research Profile
# CUSIP: 536797103
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: LITHIA MTRS INC
CUSIP: 536797103
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=LITHIA%20MTRS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 536797103
...
- The abbreviated SEC issuer name "LITHIA MTRS INC" needs manual matching
