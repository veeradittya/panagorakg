# MARKETAXESS HLDGS INC — Research Profile
# CUSIP: 57060D108
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: MARKETAXESS HLDGS INC
CUSIP: 57060D108
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=MARKETAXESS%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 57060D108
...
- The abbreviated SEC issuer name "MARKETAXESS HLDGS INC" needs manual matching
