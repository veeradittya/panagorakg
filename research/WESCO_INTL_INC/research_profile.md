# WESCO INTL INC — Research Profile
# CUSIP: 95082P105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: WESCO INTL INC
CUSIP: 95082P105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=WESCO%20INTL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 95082P105
...
- The abbreviated SEC issuer name "WESCO INTL INC" needs manual matching
