# MATRIX SVC CO — Research Profile
# CUSIP: 576853105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: MATRIX SVC CO
CUSIP: 576853105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=MATRIX%20SVC%20CO&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 576853105
...
- The abbreviated SEC issuer name "MATRIX SVC CO" needs manual matching
