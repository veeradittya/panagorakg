# UNITED AIRLS HLDGS INC — Research Profile
# CUSIP: 910047109
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: UNITED AIRLS HLDGS INC
CUSIP: 910047109
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=UNITED%20AIRLS%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 910047109
...
- The abbreviated SEC issuer name "UNITED AIRLS HLDGS INC" needs manual matching
