# PRUDENTIAL FINL INC — Research Profile
# CUSIP: 744320102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: PRUDENTIAL FINL INC
CUSIP: 744320102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=PRUDENTIAL%20FINL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 744320102
...
- The abbreviated SEC issuer name "PRUDENTIAL FINL INC" needs manual matching
