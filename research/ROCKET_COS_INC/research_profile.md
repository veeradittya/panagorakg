# ROCKET COS INC — Research Profile
# CUSIP: 77311W101
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: ROCKET COS INC
CUSIP: 77311W101
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=ROCKET%20COS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 77311W101
...
- The abbreviated SEC issuer name "ROCKET COS INC" needs manual matching
