# KINGSTONE COS INC — Research Profile
# CUSIP: 496719105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: KINGSTONE COS INC
CUSIP: 496719105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=KINGSTONE%20COS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 496719105
...
- The abbreviated SEC issuer name "KINGSTONE COS INC" needs manual matching
