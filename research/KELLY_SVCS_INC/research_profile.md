# KELLY SVCS INC — Research Profile
# CUSIP: 488152208
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: KELLY SVCS INC
CUSIP: 488152208
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=KELLY%20SVCS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 488152208
...
- The abbreviated SEC issuer name "KELLY SVCS INC" needs manual matching
