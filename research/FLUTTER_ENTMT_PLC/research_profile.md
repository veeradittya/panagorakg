# FLUTTER ENTMT PLC — Research Profile
# CUSIP: G3643J108
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: FLUTTER ENTMT PLC
CUSIP: G3643J108
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=FLUTTER%20ENTMT%20PLC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: G3643J108
...
- The abbreviated SEC issuer name "FLUTTER ENTMT PLC" needs manual matching
