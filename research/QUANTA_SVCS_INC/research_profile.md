# QUANTA SVCS INC — Research Profile
# CUSIP: 74762E102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: QUANTA SVCS INC
CUSIP: 74762E102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=QUANTA%20SVCS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 74762E102
...
- The abbreviated SEC issuer name "QUANTA SVCS INC" needs manual matching
