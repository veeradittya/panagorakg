# BV FINL INC — Research Profile
# CUSIP: 05603E208
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: BV FINL INC
CUSIP: 05603E208
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=BV%20FINL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 05603E208
...
- The abbreviated SEC issuer name "BV FINL INC" needs manual matching
