# TTEC HLDGS INC — Research Profile
# CUSIP: 89854H102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: TTEC HLDGS INC
CUSIP: 89854H102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=TTEC%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 89854H102
...
- The abbreviated SEC issuer name "TTEC HLDGS INC" needs manual matching
