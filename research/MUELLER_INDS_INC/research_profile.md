# MUELLER INDS INC — Research Profile
# CUSIP: 624756102
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: MUELLER INDS INC
CUSIP: 624756102
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=MUELLER%20INDS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 624756102
...
- The abbreviated SEC issuer name "MUELLER INDS INC" needs manual matching
