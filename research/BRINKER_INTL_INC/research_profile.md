# BRINKER INTL INC — Research Profile
# CUSIP: 109641100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: BRINKER INTL INC
CUSIP: 109641100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=BRINKER%20INTL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 109641100
...
- The abbreviated SEC issuer name "BRINKER INTL INC" needs manual matching
