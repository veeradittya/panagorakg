# SNAP ON INC — Research Profile
# CUSIP: 833034101
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: SNAP ON INC
CUSIP: 833034101
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=SNAP%20ON%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 833034101
...
- The abbreviated SEC issuer name "SNAP ON INC" needs manual matching
