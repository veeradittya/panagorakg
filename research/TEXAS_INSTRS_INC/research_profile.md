# TEXAS INSTRS INC — Research Profile
# CUSIP: 882508104
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: TEXAS INSTRS INC
CUSIP: 882508104
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=TEXAS%20INSTRS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 882508104
...
- The abbreviated SEC issuer name "TEXAS INSTRS INC" needs manual matching
