# CF INDS HLDGS INC — Research Profile
# CUSIP: 125269100
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: CF INDS HLDGS INC
CUSIP: 125269100
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=CF%20INDS%20HLDGS%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 125269100
...
- The abbreviated SEC issuer name "CF INDS HLDGS INC" needs manual matching
