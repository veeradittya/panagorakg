# OIL STS INTL INC — Research Profile
# CUSIP: 678026105
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: OIL STS INTL INC
CUSIP: 678026105
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=OIL%20STS%20INTL%20INC&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 678026105
...
- The abbreviated SEC issuer name "OIL STS INTL INC" needs manual matching
