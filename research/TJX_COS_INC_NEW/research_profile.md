# TJX COS INC NEW — Research Profile
# CUSIP: 872540109
# SEC CIK: Not matched
# Status: Requires manual SEC CIK lookup or web research

## OVERVIEW
Company name from PanAgora 13F filing: TJX COS INC NEW
CUSIP: 872540109
...
## RECOMMENDED SOURCES
1. SEC EDGAR company search: https://www.sec.gov/cgi-bin/browse-edgar?company=TJX%20COS%20INC%20NEW&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany
2. CUSIP lookup: 872540109
...
- The abbreviated SEC issuer name "TJX COS INC NEW" needs manual matching
